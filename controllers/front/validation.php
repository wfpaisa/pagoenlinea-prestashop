...
class BankwireValidationModuleFrontController extends ModuleFrontController
{
	...
	{
		$this->module->validateOrder(18, '1', 100000, 'Transferencia bancaria', NULL, $mailVars, 3, false, '1289052204abe3c7b749756a972deea5');
...
// http://localhost/mirringamirronga/www/index.php?fc=module&module=bankwire&controller=validation&id_lang=4
...
(
    ...
    [PS_OS_BANKWIRE] => 10
    [total] => 100000
    [module->displayname] => Transferencia bancaria
    [mailVars] => Array
        (
            [{bankwire_owner}] => field-titularcuenta
            [{bankwire_details}] => field-detalles
            [{bankwire_address}] => field-direccion-sucursal
        )
